...
const GUARDRAILS = [
  ...
  { title: "Set a visible miss-streak rule", body: "If you miss 2 days in a row, shrink the task, don't skip it. A 15 minute version (just BNF lookups) on a chaotic day keeps the habit alive." },
